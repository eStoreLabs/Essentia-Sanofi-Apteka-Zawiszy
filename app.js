(() => {
    const sliderPrev = document.querySelector('.es-prev')
    const sliderNext = document.querySelector('.es-next')
    ...
    const secondSliderPrev = document.querySelector('.es-prev2')
    const secondSliderNext = document.querySelector('.es-next2')
